...
<head>
    ...
    <title>Dashboard - Razer Admin</title>
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul id="active" class="nav navbar-nav side-nav">
                    ...
                    <li class="dropdown messages-dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class=""></i> Tables <b class="caret"></b></a>
                        <ul class="dropdown-menu">
                            <li class="message-preview">
                                <a href="#">
                                    <span class="avatar"><i class=""></i></span>
                                    <span class="message">Tables features</span>
                                </a>
                            </li>
                            <li class="message-preview">
                                <a href="#">
                                    <span class="avatar"><i class=""></i></span>
                                    <span class="message">Tables home</span>
                                </a>
                            </li>
                            <li class="message-preview">
                                <a href="#">
                                    <span class="avatar"><i class=""></i></span>
                                    <span class="message">Tables galeri</span>
                                </a>
                            </li>
                        </ul>
                    </li>
