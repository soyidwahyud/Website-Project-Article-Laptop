		            ...
		            <h2 class="h5 no-margin-bottom">Tabel</h2>
						    <section class="no-padding-top">
							   <div class="container-fluid">
							       <div class="row">
							        ...
							        <div class="block margin-bottom-sm">
                                      ...
                                      <td>
                                      <a href="hapus_features.php?features=<?php echo $row["idfeatures"]; ?>"onclick="return confirm('Are you sure?')" class="aksi">Delete</a>
                                    </td>
                                    <td>
                                      <a href="edit_features.php?features=<?php echo $row["idfeatures"]; ?>" class="aksi">Edit</a>
                                    </td>
						                        </tr>
						                        <?php }?>
					                    	</tbody>
                              ...
                              <form method="post" class="tambah">
                                <button  type="submit" name="submit"><a href="tambah_features.php" class="tambah">Add</a></button>
                              </form>
                              <br>
                              <br>
