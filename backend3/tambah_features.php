<?php
	...
	if (isset($_POST['submit'])) 
	{
		...
		else
		{
			...
			<script>
				alert('data invalid');
				document.location.href='tambah_features.php';
			</script>";
			echo "<br>";
...
<html>
  <head>
    ...
    <title>Add Tabel Features</title>
                ...
                <div class="content">
                  <form class="text-left form-validate" action="" method="POST" enctype="multipart/form-data">
                    <div class="form-group-material">
                      <input id="title_features" type="text" name="title_features"class="input-material">
                      <label for="title_features" class="label-material">Title Features</label>
                    </div>
                    <div class="form-group-material">
                      <input id="features" type="text" name="features" class="input-material">
