...
$jumlahdata = count(query("SELECT * FROM razermodels"));
...
$razermodels = query("SELECT * FROM razermodels LIMIT $dataawal,$jumlahdataperhalaman");

//search
if(isset($_POST["cari"]))
{
  $razermodels=cari2($_POST["keyword"]); 
} 
?>
<!DOCTYPE html>
<html>
							   ...
							   <div class="container-fluid">
							       <div class="row">
							        ...
							        <div class="block margin-bottom-sm">
							          <div class="title"><strong>Tabel Gallery</strong></div>
							            <div class="table-responsive"> 
							                ...
							                <tbody>
							                	<?php foreach($razermodels as $row){ ?>
						                        <tr>
                                      ...
                                      <td>
                                      <a href="hapus_gallery.php?gallery=<?php echo $row["no"]; ?>"onclick="return confirm('Are you sure?')" class="aksi">Delete</a>
                                      </td>
                                      <td>
                                      <a href="edit_gallery.php?gallery=<?php echo $row["no"]; ?>" class="aksi">Edit</a>
                                      </td>
						                        </tr>
						                        <?php }?>
					                    	</tbody>
						                	</table>
                              <form method="post" class="tambah3">
                                  <button  type="submit" name="submit"><a href="tambah_gallery.php" class="tambah3">Add</a></button>
                                </form>
                                <br>
                                <br>
